...
const Signup = () => {
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100">
      <div className="bg-white shadow-8xl rounded-2xl flex w-[90%] max-w-4xl overflow-hidden h-[450px]">
        ...
        {/* Image section */}
              ...
              <div className="w-1/2 hidden md:flex items-center justify-center h-[450px] border-2 border-red-500 rounded-xl">
        <Lottie
    ...
    <input
        ...
        className="w-full mb-4 px-4 py-3 border focus:ring-2 rounded-lg focus:ring-black"
    />
        <button className="w-full py-3 bg-red-500 text-white rounded-3xl font-medium hover:bg-red-600 transition">
            Sign up
          </button>
    </div>
